...
import { CreditCard, DollarSign, Download, Clock, AlertTriangle, CheckCircle, XCircle, FileText, Loader2, ArrowRight, X, Edit2, Trash2, Plus } from 'lucide-react';
  ...
  return (
    <div>
      ...
      {selectedPlan && !isProOrEnterprise && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[300] p-4" onClick={(e) => { if (e.target === e.currentTarget) { setSelectedPlan(null) } } }>
